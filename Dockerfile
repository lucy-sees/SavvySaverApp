...
# Install packages needed to build gems and PostgreSQL development libraries
...
# Set RAILS_MASTER_KEY during the build
...
# Install packages needed for deployment and PostgreSQL client
RUN apt-get update -qq && \
